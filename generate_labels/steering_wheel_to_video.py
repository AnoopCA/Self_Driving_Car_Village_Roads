...
smoothed_angle = 0
output_video_path = r'D:\ML_Projects\Self_Driving_Car_Village_Roads\steering_wheel_video.mp4.mp4'

fourcc = cv2.VideoWriter_fourcc(*'mp4v')
output_video = cv2.VideoWriter(output_video_path, fourcc, 20.0, (cols, rows))
label_file_path = r'D:\ML_Projects\Self_Driving_Car_Village_Roads\Archives\all_labels.txt'
